...
#[openapi(
	components(
		schemas(
			...
			models::user_preferences::UserPreferencesUpdate,
				...
				models::task::Task,
				models::task::TaskProgressMethod,
				models::task::TaskScheduleStatus,
				models::task::TaskExecutionStatus,
				models::task::TaskHealthStatus,
			...
			models::task_progress_component::TaskProgressComponent,
			models::task_progress_component::TaskProgressComponentInput,
			models::task_progress_component::ReplaceTaskProgressComponentsRequest,
			models::task_health::TaskHealthRule,
			models::task_health::TaskHealthRuleInput,
			models::task_health::TaskHealthRuleSetResponse,
			models::task_health::UpdateTaskHealthRulesRequest,
			...
			crate::routes::projects::TaskStatusCounts,
			crate::routes::projects::WorkloadDistributionItem,
			...
			crate::models::telemetry::TelemetryEventRequest,
				...
				crate::models::notification::NotificationActor,
				crate::models::notification::NotificationSeverity,
				crate::models::notification::Notification,
				crate::models::notification::MarkNotificationsReadRequest,
				crate::models::notification::NotificationUnreadCountResponse,
				crate::models::notification::NotificationsReadResponse,
				crate::models::realtime::RealtimeEventFamily,
				crate::models::realtime::RealtimeActor,
				crate::models::realtime::PresenceStatus,
				crate::models::realtime::RealtimePresenceUser,
				crate::models::realtime::RealtimePresenceMetadata,
				crate::models::realtime::RealtimeNotificationCounterMetadata,
				crate::models::realtime::RealtimeInvalidateMetadata,
				crate::models::realtime::RealtimeEventMetadata,
				crate::models::realtime::RealtimeEvent,
				crate::models::realtime::RealtimeErrorMessage,
				crate::models::realtime::RealtimeClientCommand,
				crate::routes::realtime::RealtimeWsQuery,
	...
	paths(
		...
		crate::routes::projects::delete_project,
			...
			crate::routes::projects::get_task_health_rules,
			crate::routes::projects::update_task_health_rules,
		...
		crate::routes::tasks::list_task_progress_components,
		crate::routes::tasks::replace_task_progress_components,
		...
		crate::routes::notifications::get_unread_notification_count,
		crate::routes::notifications::mark_notifications_read,
		crate::routes::notifications::mark_notifications_read_all,
		crate::routes::realtime::websocket_feed,
	...
	tags(
		...
		(name = "Realtime", description = "WebSocket realtime feed"),
